    ...
    for pos in positions:
        ...
        if pos_side == "long":
            ...
            if current_price <= stop_price:
                ...
                trade_id = _close_position(conn, ticker, qty, "SELL", current_price, reason)
                closed.append({"ticker": ticker, "reason": reason,
                                "pnl": (current_price - avg_entry) * qty,
                                "is_stop_loss": True, "trade_id": trade_id, "signals": {}})
                ...
                closed.append({"ticker": ticker, "reason": reason,
                                "pnl": (current_price - avg_entry) * qty,
                                "is_stop_loss": False, "trade_id": trade_id, "signals": {}})
            ...
            if current_price >= stop_price:
                ...
                trade_id = _close_position(conn, ticker, qty, "BUY", current_price, reason)
                closed.append({"ticker": ticker, "reason": reason,
